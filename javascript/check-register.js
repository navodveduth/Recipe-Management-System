function validateRegisterDetails() {
    ...
    var User_email = document.Register.email.value;
    var User_Password = document.Register.password.value;
    var User_PasswordCheck = document.Register.passwordCheck.value;
    ...
    else if (User_PasswordCheck==null || User_PasswordCheck==""){  
    ...
    else if (!(passwordCheck.test(User_PasswordCheck))){  
        alert("Password must have a capital letter, simple letter, numeral and special character. Password length should be between 10 and 30"); 
        return false;
    }
